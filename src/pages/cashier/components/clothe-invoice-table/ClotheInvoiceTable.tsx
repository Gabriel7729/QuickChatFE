...
import { getEnumName, getEnumSelectOptions } from "../../../../common/utils/enum.utils";
import { IconFilePlus, IconListDetails } from "@tabler/icons-react";
import queryString from "query-string";

export const ClotheInvoiceTable = () => {
  ...
  const tableConfig: TableConfig<ListInvoicePaginatedResponseDto> = {
    ...
    buttonOptions: [
      {
        type: "action",
        icon: <IconFilePlus style={iconStyle} />,
        text: "Agregar",
        show: true,
        handler: () => {
          navigate("/facturas/agregar/ropa");
        },
      },
    ],
    actions: [
...
export default ClotheInvoiceTable;
