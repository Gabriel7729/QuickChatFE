...
interface LastInvoicePacaFromCustomerTableProps {
  id: string;
}

const LastInvoicePacaFromCustomerTable: React.FC<
  LastInvoicePacaFromCustomerTableProps
> = ({ id }) => {
  ...
  const tableConfig: TableConfig<ListInvoicePaginatedResponseDto> = {
    titleTable: "Últimas facturas de Pacas del cliente",
    data: {
...
export default LastInvoicePacaFromCustomerTable;
